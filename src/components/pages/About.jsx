...
const About = () => {
  return (
    <>
      <div className='w-full mt-5 mb-10 lg:mb-5 py-20 lg:py-5'>
        {/* About Me part Start */}
        <div className="">
          ...
          <p className='text-center lg:text-start pt-5 text-md text-neutral-400 leading-6.5 px-2 w-1/2 lg:w-full m-auto'>
        ...
        <div className="mt-10">
          ...
          <div className="flex justify-start items-center gap-x-5 gap-y-5 mt-5 flex-wrap">
            ...
            <div className="w-[60%] lg:w-[48%] m-auto h-[250px] lg:h-[180px] bg-[#202022] px-5 py-10 rounded-lg shadow shadow-gray-700">
              <div className="flex flex-col lg:flex-row items-center lg:items-start text-center lg:text-left gap-5">
        ...
        <div className="mt-10 py-5">
          ...
          <div className="w-full pt-5 flex justify-center lg:justify-between items-center m-auto flex-wrap gap-y-40">
            <div className="w-[95%] lg:w-[48%] m-auto h-[350px] lg:h-[300px]">
              <h4 className="w-full pb-5 text-xl font-semibold text-center">Front-End</h4>  {/* Centered like lg */}
            ...
            <div className="w-[95%] lg:w-[48%] m-auto h-[350px] lg:h-[300px]">
              <h4 className="w-full pb-5 text-xl font-semibold text-center">Back-End</h4>  {/* Guessed this; update if wrong */}
              <div className="w-full h-[350px] lg:h-[310px] bg-[#202022] gap-2 flex justify-between items-center flex-wrap rounded-lg shadow shadow-gray-700">
