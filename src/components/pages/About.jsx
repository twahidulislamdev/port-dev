      ...
      <div className="w-full mb-10 lg:mb-5 lg:py-5">
        ...
        <div className="">
          ...
          <p className="text-center lg:text-start pt-5 text-md text-neutral-400 leading-6.5  lg:w-full m-auto">
            I’m a passionate MERN Stack Developer committed to creating
            innovative, high-quality web and mobile applications. Having
            completed my journey in Front-End, Back-End, and React Native
            development, I’ve built strong expertise in React.js, Next.js, Redux
            Toolkit, Tailwind CSS, Node.js, Express.js, MongoDB, MySQL, and
            React Native.
            <br />
            <br />
            My mission is to craft seamless, scalable, and user-focused
            applications that deliver exceptional experiences. I’m now excited
            to take the next step as a Frontend Developer or MERN Stack
            Developer, where I can apply my skills, contribute to impactful
            projects, and grow with an innovative team.
          </p>
        </div>
        {/* About Me part End */}
            ...
            <div className="w-full lg:w-[48%] m-auto h-[200px] lg:h-[180px] bg-[#202022] px-5  py-0 lg:py-10 rounded-lg shadow shadow-neutral-600">
              <div className="flex flex-col lg:flex-row items-center lg:items-start text-center lg:text-left gap-5 py-2">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-neutral-400">
                    Professional development of applications for Cross Platform
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mb-40 lg:mb-0 mt-10 py-5">
          ...
          <div className="w-full mt-10 flex justify-center lg:justify-between items-center m-auto flex-wrap gap-y-40">
            <div className="w-[95%] lg:w-[48%] m-auto h-[350px] lg:h-[300px]">
              <h4 className="w-full pb-3 text-xl font-semibold text-start lg:text-center">
                Front-End (){" "}
              </h4>{" "}
              {/* Centered like lg */}
              <div className="w-full h-[350px] lg:h-[230px] bg-[#202022] gap-2 flex justify-between  flex-wrap rounded-lg shadow-none lg:shadow shadow-gray-700">
                ...
                <SkillsIcon
                  className={""}
                  SkillsLogo={ReduxLogo}
                  logoName={"Redux"}
                />
                <SkillsIcon
                  className={""}
                  SkillsLogo={NextJsLogo}
                  logoName={"Next.js"}
                />
                <SkillsIcon
                  className={""}
